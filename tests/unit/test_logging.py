...
class _FakeHandler:
    def get_tool_description(self):
        return Tool(name="fake_tool", description="", input_schema={"type": "object"})
...
class TestDispatchRedaction:
    ...
    def test_unknown_tool_returns_in_band_error(self):
        from mcp_logseq.server import _dispatch_tool_call

        result = asyncio.run(_dispatch_tool_call({}, "nope", {}))
